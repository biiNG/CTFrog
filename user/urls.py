...
urlpatterns = [
    ...
    path('profile/<path:username>', user_views.profile, name='profile'),
    ...
    path('team/apply/<int:apply_id>/approved', team_views.applyapproved, name='teamapplyapproved'),
    path('team/apply/<int:apply_id>/denied', team_views.applydenied, name='teamapplydenied'),
